...
func main(){
	...
	var folha0 = Tree{Value:"r", Sons: nil}
	var folha1 = Tree{Value:"1", Sons: nil}
	var folha2 = Tree{Value:"n", Sons:nil}
	var folha3 = Tree{Value:"10", Sons:nil}
	var filho0 = Tree{Value:"att", Sons: append(append(initSons(),&folha0),&folha1)}
	var filho1 = Tree{Value:"att", Sons: append(append(initSons(),&folha2),&folha3)}
	
	var folha4 = Tree{Value:"n", Sons:nil}
	var folha5 = Tree{Value:"1", Sons:nil}
	var whileFilho0 = Tree{Value: "gt", Sons: append(append(initSons(),&folha4),&folha5)}

	var folha6 = Tree{Value:"r", Sons:nil}
	var folha7 = Tree{Value:"r", Sons:nil}
	var folha8 = Tree{Value:"n", Sons:nil}
	var supFolha78 = Tree{Value:"mul", Sons: append(append(initSons(),&folha7),&folha8)}
	var supsup1 = Tree{Value:"att", Sons: append(append(initSons(),&folha6),&supFolha78)}

	var folha9 = Tree{Value:"n", Sons:nil}
	var folha10 = Tree{Value:"n", Sons:nil}
	var folha11 = Tree{Value:"1", Sons:nil}
	var supFolha1011 = Tree{Value:"sub", Sons: append(append(initSons(),&folha10),&folha11)}
	var supsup2 = Tree{Value:"att", Sons:append(append(initSons(),&folha9),&supFolha1011)}

	var whileFilho1 = Tree{Value:"seq", Sons:append(append(initSons(),&supsup1),&supsup2)}
	var filho2 = Tree{Value:"while", Sons: append(append(initSons(),&whileFilho0),&whileFilho1)}
	
	
	var raiz = Tree{Value:"seq", Sons: append(append(append(initSons(),&filho0),&filho1),&filho2)}
	resolverSMC(iniciaSMC(),raiz)		
}
